...
// MAIN
export default function EditDocPage(props) {
  ...
  function actualHandleSubmit(e, navigate) {
    ...
    const url = endpoints["mrDocEdit"] + thisDoc._id;
    ...
    axios
      ...
      .then((res) => {
        if (res.status === 200) {
          alert(
            "Doctor Edited ID: " + res.data.data.doctor.doctorRegistrationNumber
          );
          navigate("/");
        } else {
  ...
  useEffect(() => {
    ...
    const myDoc = JSON.parse(localStorage.getItem("ZDSMYDOC") || {});

    if (myDoc.email.length < 1) {
    ...
    <>
      ...
      <Container>
        <Formik
          ...
          initialValues={{
            firstName: thisDoc.firstName,
            middleName: thisDoc.middleName,
            lastName: thisDoc.lastName,
            email: thisDoc.email,
            contactNumber: thisDoc.contactNumber.number,
            alternateContactNumber: (
              thisDoc.alternateContactNumber || { number: "" }
            ).number,
            emergencyContactNumber: (
              thisDoc.emergencyContactNumber || { number: "" }
            ).number,
            address: thisDoc.address,
            district: thisDoc.district,
            pincode: thisDoc.pincode,
            doctorType: thisDoc.doctorType,
            doctorRegistrationNumber: thisDoc.doctorRegistrationNumber,
            gender: thisDoc.gender,
            foodPreference: thisDoc.foodPreference,
          }}
        >
          {({
            handleSubmit,
                ...
                <Form.Group className="mb-3">
                  <ButtonGroup>
                    <Form.Check
                      ...
                      checked={thisDoc.doctorType === DoctorType.WBMC}
                      style={{
                        borderColor: "#237547",
                        margin: "4px 1px 4px 1px",
                      }}
                    ...
                    <Form.Check
                      ...
                      checked={thisDoc.doctorType === DoctorType.OTHERS}
                      style={{
                        borderColor: "#237547",
                        margin: "4px 1px 4px 1px",
                      }}
                ...
                <Form.Group className="mb-3">
                  <ButtonGroup>
                    <Form.Check
                      ...
                      checked={thisDoc.gender === GenderType.MALE}
                      style={{
                        borderColor: "#237547",
                        margin: "4px 1px 4px 1px",
                      }}
                    ...
                    <Form.Check
                      ...
                      checked={thisDoc.gender === GenderType.FEMALE}
                      style={{
                        borderColor: "#237547",
                        margin: "4px 1px 4px 1px",
                      }}
                    ...
                    <Form.Check
                      ...
                      checked={thisDoc.gender === GenderType.NON_BINARY}
                      style={{
                        borderColor: "#237547",
                        margin: "4px 1px 4px 1px",
                      }}
                ...
                <Form.Group className="mb-3">
                  <ButtonGroup>
                    <Form.Check
                      ...
                      checked={thisDoc.foodPreference === FoodPreference.VEG}
                      style={{
                        borderColor: "#237547",
                        margin: "4px 1px 4px 1px",
                      }}
                    ...
                    <Form.Check
                      ...
                      checked={
                        thisDoc.foodPreference === FoodPreference.NON_VEG
                      }
                      style={{
                        borderColor: "#237547",
                        margin: "4px 1px 4px 1px",
